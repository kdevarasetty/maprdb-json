...
public class TypesBean {
	...
	public TypesBean init() {
		...
		objectListT = ImmutableList.of(1, 23.5, 12.0f, "hello",
				new ChildObject());
	...
	@Override
	public String toString() {
		return "{nullT: " + nullT + ", booleanT: " + booleanT + ", stringT: "
				+ stringT + ", byteT: " + byteT + ", shortT: " + shortT
				+ ", intT: " + intT + ", longT: " + longT + ", floatT: "
				+ floatT + ", doubleT: " + doubleT + ", bigDecimalT: "
				+ bigDecimalT + ", dateT: " + dateT + ", timeT: " + timeT
				+ ", timestampT: " + timestampT + ", intervalT: " + intervalT
				+ ", byteBufferT: " + byteBufferT + ", intArrayT: "
				+ Arrays.toString(intArrayT) + ", objectListT: " + objectListT
				+ ", childObjectT: " + childObjectT + "}";
	}
